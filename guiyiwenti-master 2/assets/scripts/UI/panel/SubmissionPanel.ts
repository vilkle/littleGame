...
export default class SubmissionPanel extends BaseUI {
    ...
    DetectionNet() {
        ...
        let gameDate = GameData.getInstance();
        let data = JSON.stringify({ CoursewareKey: ConstValue.CoursewareKey, gameScene: gameDate.gameScene, methodTime: gameDate.methodTime, totalNum: gameDate.totalNum, time: gameDate.time, num: gameDate.num, method1: gameDate.method1, method2: gameDate.method2 });
